import type { GameMode, IDDragonSummonerSpell } from 'types';
...
export class SummonerSpell {
  ...
  /**
   * The image of this summoner spell.
   */
   ...
   */
  constructor(client: Client, data: IDDragonSummonerSpell) {
    ...
    this.image = new Image(client, data.image);
  }
